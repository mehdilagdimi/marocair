        ...
        <div class="max-w-sm mx-auto px-6">
            <div class="relative flex flex-wrap">
                <div class="w-full relative">
                    <div class="mt-6">
                        <div class="mb-2 pb-1 border-b-2 text-center font-base text-gray-700">
                            <span>Welcome to marocair!</span>
                        </div>
                ...
                focus:outline-none">
                    ...
                    Me </span></label> <label class="block text-gray-500 font-bold my-4"><a
                                        href="#"
                                        class="cursor-pointer tracking-tighter text-black border-b-2 border-gray-200 hover:border-gray-400"><span>Create account</span></a></label>
                                </div>

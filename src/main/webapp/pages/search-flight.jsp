...
<%--                        </svg>--%>
            ...
            <div class="flex justify-center"><button type="submit"  name="searchflight" value="true" class="p-2 border w-1/4 rounded-md bg-gray-800 text-white">Search</button></div>
        </div>
    </div>
</div>
</form>

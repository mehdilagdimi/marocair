...
<div class="flex min-h-screen">
    <aside class="w-64 flex-2 min-h-screen bg-gray-50" aria-label="Sidebar">
        <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
            <a href="#" class="flex items-center pl-2.5 mb-5">
                ...
                <span class="ml-2 self-center text-xl font-semibold whitespace-nowrap dark:text-white">MarocAir</span>
            </a>
            <ul class="space-y-2">
                <li>
                    <a href="<%= url+"flight"%>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <li>
                    <a href="<%= url+"flight" %>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Flights</span>
                        <span class="inline-flex justify-center items-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                    </a>
                </li>
                <li>
                    <a href="<%= url+"admin/add-flight.jsp" %>" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Add flights</span>
    ...
    <div class="flex-auto w-full">
        <nav class="h-16 bg-[#F9FAFB] flex items-center m-3 rounded-lg">
            <c:choose>
